...
import 'package:animaltinder/ui/validators.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Stream<LoginState> transformEvents(
    ...
    return super
        .transformEvents(nonDebounceSteam.mergeWith([debounceStream]), next);
  }
  ...
  Stream<LoginState> _mapLoginWithCredentialsPressedToState({String email, String password}) async* {
    ...
    try {
      await _userRepository.sighInWithEmail(email, password);
